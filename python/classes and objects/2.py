...
class cq:
    ...
    def display(self,opt):                              # display
        if opt==1:
            ...
            elif (self.rear >= self.front):                       # if rear> = front 
            # then front to rear+1 in one line
                for i in range(self.front, self.rear + 1):               # front to rear+1
                    s=s+' '+self.queue[i]                
                return s                                            
            else:
            # if front> rear   # eg- f=4 and rear=2
                for i in range(self.front, self.size):              # from front to size
                    s=s+' '+self.queue[i]         
                for i in range(0, self.rear + 1):              # from 0 to rear+1
                    s=s+' '+self.queue[i]         
            return s                                      
